...
public class ShowResult07 extends javax.swing.JFrame {
    ...
    public ShowResult07() {
     ...
     public ShowResult07(int a, int b,int c, int d) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(30, 410, 70, 34);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowResult07.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowResult07().setVisible(true);
            }
        });
    }
